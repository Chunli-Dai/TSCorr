...
%v4.1, e.g., '/Users/chunlidai/Downloads/07_42_2_1_2m_v4.1/07_42_2_1_2m_v4.1_dem.tif'
% Chunli Aug 2023
% works for both old and new version of dem data.
ModelPixelScaleTag=Tinfo(1).ModelPixelScaleTag;
ModelTiepointTag=Tinfo(1).ModelTiepointTag;
